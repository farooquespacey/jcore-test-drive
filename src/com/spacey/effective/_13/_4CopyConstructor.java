...
public class _4CopyConstructor {
	...
	// class with typical copy cons and copy factory
	static final class PhoneNumber {
		...
		public PhoneNumber(PhoneNumber pn) {
			...
			this.lineNum = pn.lineNum;
		}

		// copy factory
		public static PhoneNumber newInstance(PhoneNumber pn) {
			return new PhoneNumber(pn.areaCode, pn.prefix, pn.lineNum);
		}
