 ...
 *
 */
public class _2ClassAdapterPattern {
	...
	static class TriangleAdapter extends Triangle implements Shape {
	...
	// Class Adapter Pattern
	static class RhombusAdapter extends Rhombus implements Shape {
